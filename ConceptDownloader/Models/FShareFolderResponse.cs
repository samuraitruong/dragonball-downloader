...
namespace ConceptDownloader.Models
{
    ...
    public partial class FShareFolderResponse
    {
        public static FShareFolderResponse FromJson(string json) => JsonConvert.DeserializeObject<FShareFolderResponse>(json, ConceptDownloader.Models.FShareFolderResponseConverter.Settings);
    }

    public static class FShareFolderResponseSerialize
    {
        public static string ToJson(this FShareFolderResponse self) => JsonConvert.SerializeObject(self, ConceptDownloader.Models.FShareFolderResponseConverter.Settings);
    }
